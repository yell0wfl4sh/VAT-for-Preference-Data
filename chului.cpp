...
signed main(){
   ...
   //  vvi A{	{ -INF, 5, 1, 1 },
    ...
    vector<vector<float>>  vx {
            {0.5 , 0.63 , 0.38 , 0.4 , 0.67 , 0.7 , 0.77 , 0.79 , 0.55 , 0.65 , 0.35 , 0.6 },
            {0.37 , 0.5 , 0.23 , 0.24 , 0.55 , 0.58 , 0.7 , 0.72 , 0.37 , 0.53 , 0.23 , 0.49 },
            {0.62 , 0.77 , 0.5 , 0.55 , 0.8 , 0.84 , 0.91 , 0.94 , 0.68 , 0.78 , 0.45 , 0.74 },
            {0.6 , 0.76 , 0.45 , 0.5 , 0.81 , 0.82 , 0.9 , 0.94 , 0.66 , 0.77 , 0.4 , 0.75 },
            {0.33 , 0.45 , 0.2 , 0.19 , 0.5 , 0.6 , 0.67 , 0.68 , 0.32 , 0.44 , 0.18 , 0.46 },
            {0.3 , 0.42 , 0.16 , 0.18 , 0.4 , 0.5 , 0.66 , 0.67 , 0.3 , 0.41 , 0.15 , 0.43 },
            {0.23 , 0.3 , 0.09 , 0.1 , 0.33 , 0.34 , 0.5 , 0.53 , 0.22 , 0.33 , 0.08 , 0.28 },
            {0.21 , 0.28 , 0.06 , 0.06 , 0.32 , 0.33 , 0.47 , 0.5 , 0.25 , 0.3 , 0.05 , 0.27 },
            {0.45 , 0.63 , 0.32 , 0.34 , 0.68 , 0.7 , 0.78 , 0.75 , 0.5 , 0.65 , 0.3 , 0.61 },
            {0.35 , 0.47 , 0.22 , 0.23 , 0.56 , 0.59 , 0.67 , 0.7 , 0.35 , 0.5 , 0.21 , 0.48 },
            {0.65 , 0.77 , 0.55 , 0.6 , 0.82 , 0.85 , 0.92 , 0.95 , 0.7 , 0.79 , 0.5 , 0.75 },
            {0.4 , 0.51 , 0.26 , 0.25 , 0.54 , 0.57 , 0.72 , 0.73 , 0.39 , 0.52 , 0.25 , 0.5 }
            };


    vvi v(sz(vx), vector<int>(sz(vx[0]), 0));
...
*/
    ...
    vector<int> setforordering(N, 0);
    For(i, 0, N){
        For(j, 0, sz(adj[i])){
            setforordering[adj[i][j].F]++;
        }
    }

    For(i, 0, N){
        if(setforordering[i]==0){
            ordering(i);
            break;
        }
    }
