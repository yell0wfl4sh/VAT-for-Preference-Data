...
df1=pd.read_csv('F:/btpbarclays/2000-2001.csv')
df1=df1[['HomeTeam','AwayTeam','FTR']]
df2=pd.read_csv('F:/btpbarclays/2001-2002.csv')
df2=df2[['HomeTeam','AwayTeam','FTR']]
df3=pd.read_csv('F:/btpbarclays/2002-2003.csv')
df3=df3[['HomeTeam','AwayTeam','FTR']]
df4=pd.read_csv('F:/btpbarclays/2003-2004.csv')
df4=df4[['HomeTeam','AwayTeam','FTR']]
df5=pd.read_csv('F:/btpbarclays/2004-2005.csv')
df5=df5[['HomeTeam','AwayTeam','FTR']]
df6=pd.read_csv('F:/btpbarclays/2005-2006.csv')
df6=df6[['HomeTeam','AwayTeam','FTR']]
df7=pd.read_csv('F:/btpbarclays/2006-2007.csv')
df7=df7[['HomeTeam','AwayTeam','FTR']]
df8=pd.read_csv('F:/btpbarclays/2007-2008.csv')
df8=df8[['HomeTeam','AwayTeam','FTR']]
df9=pd.read_csv('F:/btpbarclays/2008-2009.csv')
df9=df9[['HomeTeam','AwayTeam','FTR']]
df10=pd.read_csv('F:/btpbarclays/2009-2010.csv')
df10=df10[['HomeTeam','AwayTeam','FTR']]
df11=pd.read_csv('F:/btpbarclays/2010-2011.csv')
df11=df11[['HomeTeam','AwayTeam','FTR']]
df12=pd.read_csv('F:/btpbarclays/2011-2012.csv')
df12=df12[['HomeTeam','AwayTeam','FTR']]
df13=pd.read_csv('F:/btpbarclays/2012-2013.csv')
